...
class Net(nn.Module):
    ...
    def forward(self, input_data):
        ...
        total_out_forward = total_out_forward.reshape(total_out_forward.shape[0], -1, self.output_dim)
        total_out_forward = total_out_forward.transpose(2,1)
        #total_out_backward = total_out_backward.reshape(total_out_backward.shape[0], self.output_dim, -1)
        total_out_backward = total_out_backward.reshape(total_out_backward.shape[0], -1, self.output_dim)
        total_out_backward = total_out_backward.transpose(2,1)
